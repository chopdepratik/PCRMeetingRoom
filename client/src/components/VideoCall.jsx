    ...
    <div className="call-container">
            ...
            <div className="audio-video-toggle">
              <div className="sub-audio-video-toggle">
                <p onClick={toggleVideo}>
                  {isVideoOn ? <img src={videoImg} alt="" /> : <img src={noVideoImg} alt="" />}
                </p>
                <p onClick={toggleAudio}>
                  {isAudioOn ? <img src={micImg} alt="" /> : <img src={noMicImg} alt="" />}
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="controls">
        {host._id === currentUser._id ? (
          ...
          ) : meetStarted ? '' : <p>Wait while other user joins the room</p>
